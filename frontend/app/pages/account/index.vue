<template>
  <div class="min-h-screen p-4 sm:p-8 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white transition-colors">
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 sticky top-24">
          <div class="flex flex-col items-center mb-6">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300">
              {{ role !== "USER" ? "Premium Member" : "Thành viên" }}
            </p>
          </div>
      ...
      <div class="w-full md:w-3/4 space-y-6">
        <!-- GENERAL -->
        <section v-if="currentTab === 'general'" class="bg-white dark:bg-gray-800 rounded-lg p-6 sm:p-8">
        ...
        <!-- SECURITY -->
        <section v-if="currentTab === 'security'" class="bg-white dark:bg-gray-800 rounded-lg p-6 sm:p-8">
          ...
          <div class="space-y-6 max-w-lg">
            <div>
              ...
              <div class="input-with-toggle relative">
                ...
                <button type="button" @click="showPass.current = !showPass.current" class="password-toggle" :aria-pressed="showPass.current" :aria-label="showPass.current ? 'Ẩn mật khẩu' : 'Hiện mật khẩu'">
            ...
            <div>
              ...
              <div class="input-with-toggle relative">
                ...
                <button type="button" @click="showPass.new = !showPass.new" class="password-toggle" :aria-pressed="showPass.new" :aria-label="showPass.new ? 'Ẩn mật khẩu' : 'Hiện mật khẩu'">
            ...
            <div>
              ...
              <div class="input-with-toggle relative">
                ...
                <button type="button" @click="showPass.confirm = !showPass.confirm" class="password-toggle" :aria-pressed="showPass.confirm" :aria-label="showPass.confirm ? 'Ẩn mật khẩu' : 'Hiện mật khẩu'">
        ...
        <!-- THEME -->
        <section v-if="currentTab === 'theme'" class="bg-white dark:bg-gray-800 rounded-lg p-6 sm:p-8">
  ...
  <!-- track -->
  <span class="absolute inset-0 rounded-full bg-gray-400 transition-colors peer-checked:bg-sky-500"></span>
...
const defaultAvatar = 'https://storage.googleapis.com/maker-studio-project-media-prod/11072a6a-d42a-41e9-8902-613d0a6a0e69/images/220b33b9-a99f-4318-9126-d66a6a96f131.jpg';
...
async function handleProfileUpdate() {
  ...
  try {
    ...
    const updatedUser = (await handleResponse(res)) as { username?: string; avatarUrl?: string };
    showToast('Cập nhật thông tin thành công!', 'success');
    if (updatedUser.username) { username.value = updatedUser.username; profile.name = updatedUser.username; }
...
async function handleChangePassword() {
  ...
  const body = { username: username.value, oldPassword: passwords.current, newPassword: passwords.new };
...
.slider { position: absolute; cursor: pointer; top: 0; left: 0; right: 0; bottom: 0; background-color: #9ca3af; transition: 0.3s; border-radius: 9999px; }
