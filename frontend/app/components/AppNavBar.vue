...
<template>
    ...
    class="bg-white dark:bg-neutral-900 px-6 py-3 flex items-center justify-between border-b border-gray-200 dark:border-b-neutral-800 transition-colors"
  ...
  >
      ...
      <div class="relative flex items-center cursor-pointer group">
        ...
        <div class="flex-1 flex justify-center">
            ...
            <nav class="flex space-x-4 text-gray-500 dark:text-gray-400">

                <NuxtLink

          to="/"

          class="flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-700 dark:hover:text-white [&.router-link-exact-active]:bg-gray-200 [&.router-link-exact-active]:text-primary-600 dark:[&.router-link-exact-active]:bg-neutral-600 dark:[&.router-link-exact-active]:text-primary-400"
        ...
        <div class="flex items-center space-x-4 relative">
            ...
            <span v-if="isAuthenticated" class="text-gray-700 dark:text-gray-300 whitespace-nowrap">
      ...
      <div class="relative group">
        ...
        <div>
          ...
          class="absolute right-0 mt-2 w-32 bg-white border border-gray-200 dark:bg-neutral-800 dark:border-neutral-700 rounded shadow-lg z-10 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity"
