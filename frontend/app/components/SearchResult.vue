<template>
    ...
    <div class="space-y-6">
      ...
      >
        ...
        >
          ...
          <div
            ...
            v-if="result.kanji.tips && result.kanji.tips.vi"
      ...
      <div
        ...
        v-if="result && result.type === 'word' && result.words && result.words.length > 0"
      ...
      <div
        ...
        v-if="result && result.type === 'word' && result.suggestWords && result.suggestWords.length > 0"
