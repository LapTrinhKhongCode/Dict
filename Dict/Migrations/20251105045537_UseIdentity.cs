        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedTerm = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SearchMisses", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "SiteStatsHistory",
                columns: table => new
                {
                    ...
                    TotalReviewsToday = table.Column<int>(type: "int", nullable: false),
                    TotalApiErrorsToday = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SiteStatsHistory", x => x.Date);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchMisses_NormalizedTerm",
                table: "SearchMisses",
                column: "NormalizedTerm",
                unique: true);

            migrationBuilder.AddForeignKey(
                name: "FK_card_states_AspNetUsers_UserId",
                table: "card_states",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_media_store_AspNetUsers_OwnerId",
                table: "media_store",
                column: "OwnerId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ocr_jobs_AspNetUsers_UserId",
                table: "ocr_jobs",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_review_logs_AspNetUsers_UserId",
                table: "review_logs",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
